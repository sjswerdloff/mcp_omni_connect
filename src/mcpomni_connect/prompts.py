...
async def find_prompt_server(name: str, available_prompts: dict[str, list[str]]) -> tuple[str, bool]:
...
async def get_prompt(
    ...
    if not found:
        ...
        await add_message_to_history("user", error_message, {"prompt_name": name, "error": True})
    ...
    try:
        ...
        prompt_response = await sessions[server_name]["session"].get_prompt(name, arguments)
