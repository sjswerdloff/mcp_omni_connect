...
async def find_resource_server(uri: str, available_resources: dict[str, list[str]]) -> tuple[str, bool]:
...
async def read_resource(
    ...
    if not found:
        ...
        await add_message_to_history("user", error_message, {"resource_uri": uri, "error": True})
