...
async def process_query(
    ...
    await add_message_to_history("assistant", initial_response, tool_calls_metadata)
    ...
    if assistant_message.tool_calls:
        ...
        for tool_call in assistant_message.tool_calls:
            ...
            try:
                ...
                await add_message_to_history("tool", str(tool_content), {
                    "tool_call_id": tool_call.id,
                    "tool": tool_name,
                    "args": tool_args
                })
                ...
                await add_message_to_history("tool", error_message, {
                    "tool_call_id": tool_call.id,
                    "tool": tool_name,
                    "args": tool_args,
                    "error": True
        ...
        try:
            ...
            logger.error(error_message)
            await add_message_to_history("assistant", error_message, {"error": True})
